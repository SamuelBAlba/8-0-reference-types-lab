...
// add a new store to the end .push()
...
// creates new strore object
let newStore = {}
// sets the .name from store to newStore
newStore.name = store.name
// creates new .boardGame array
newStore.boardGames = []
// loop to add the games to the .boardgame key
